...
cave_colors <- c(
  "Fata Apei Cave " = "cyan3",
  "Ferice Cave " = "dodgerblue2",
  "Nestor Cave " = "darkorchid",
  "Tausoare Cave " = "deeppink3")
```
...
iNEXT_color_df <- 
  ...
  left_join(data.frame(cave_colors = cave_colors, cave = names(cave_colors)), by = "cave")
```
...
- Richness:  
    - Fata Apei Cave seems to have significantly higher richness than the others. All the other caves have similar richness. 
    
- Shannon's Diversity
    - Fata Apei Cave seems to have significantly higher Shannon's Diversity than the other caves as well. All the other caves have similar Simpson's Diversity. Tausoare Cave seems like it has slightly lower Shannon's Diversity than the other caves.
  
- Simpson's Diversity:  
    - Fata Apei Cave seems to have significantly higher Simpson's Diversity than the other caves as well. All the other caves have similar Simpson's Diversity. Tausoare Cave seems like it has slightly lower Simpson's Diversity than the other caves.
...
- **Fata Apei Cave** appears to have significantly greater richness, Shannon, and Simpson diversity than the others.
- **Ferice Cave** appears to have the most variation in richness, Shannon, and Simpson diversity.
- **Tausoare Cave** appears to have the lowest Shannon and Simpson diversity.
- **Ferice Cave** and **Nestor Cave** appear to have similar levels of richness, Shannon, and Simpson diversity.
